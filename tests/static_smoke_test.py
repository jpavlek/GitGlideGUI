#!/usr/bin/env python3
"""Static smoke tests for the Git Glide GUI v3.6.10.1 package.
...
required = [
    ...
    "scripts/windows/GitGlideGUI-v3.6.10.1.ps1",
    ...
    "docs/START_HERE.md",
    "docs/RELEASE_NOTES_v3_6_10_1.md",
    "docs/SWOT_AND_ROADMAP_v3_6_10_1.md",
    "docs/ROADMAP_REVIEW_v3_6_10_1.md",
]
...
main = (ROOT / "scripts/windows/GitGlideGUI-v3.6.10.1.ps1").read_text(encoding="utf-8")
for marker in [
    "Git Glide GUI v3.6.10.1",
...
if "GitGlideGUI-v3.6.10.1.ps1" not in launcher:
    print("Launcher does not target v3.6.10.1 script.")
    sys.exit(1)
