#!/usr/bin/env python3
"""Static smoke tests for the Git Glide GUI v3.6.12 package.
...
required = [
    ...
    "scripts/windows/GitGlideGUI-v3.6.12.ps1",
...
main = (ROOT / "scripts/windows/GitGlideGUI-v3.6.12.ps1").read_text(encoding="utf-8")
for marker in [
...
if "GitGlideGUI-v3.6.12.ps1" not in launcher:
    print("Launcher does not target v3.6.12 script.")
    sys.exit(1)
